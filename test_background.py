...
def test(train_set, test_set):
    ...
    axes[0].hist(class_0['emd_gaze_aug'], bins=100, weights=np.ones(len(class_0['emd_gaze_aug'])) / len(class_0['emd_gaze_aug']))
    axes[1].hist(class_1['emd_gaze_aug'], color="#ff7f0e", bins=100, weights=np.ones(len(class_1['emd_gaze_aug'])) / len(class_1['emd_gaze_aug']))
